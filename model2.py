...
# plt.scatter(y_test, y_pred_linear, alpha=0.7, label='Predicted (Linear)')
# plt.plot([y_test.min(), y_test.max()], [y_test.min(), y_test.max()], 'r--', label='Ideal')
# plt.xlabel('Actual Lap Time (sec)')
# plt.ylabel('Predicted Lap Time (sec)')
# plt.title('Linear Regression: Actual vs Predicted Lap Times')
# plt.legend()
# plt.grid(True)
# plt.tight_layout()
# plt.show()
#
# # Scatter plot: Real vs Predicted (Decision Tree)
# plt.figure(figsize=(8, 6))
# plt.scatter(y_test, y_pred_tree, alpha=0.7, label='Predicted (Tree)', color='g')
# plt.plot([y_test.min(), y_test.max()], [y_test.min(), y_test.max()], 'r--', label='Ideal')
# plt.xlabel('Actual Lap Time (sec)')
# plt.ylabel('Predicted Lap Time (sec)')
# plt.title('Decision Tree: Actual vs Predicted Lap Times')
# plt.legend()
# plt.grid(True)
# plt.tight_layout()
# plt.show()
#
# # Scatter plot: Real vs Predicted (Optimized Decision Tree)
# plt.figure(figsize=(8, 6))
# plt.scatter(y_test, y_pred_best_tree, alpha=0.7, label='Predicted (Optuna Tree)', color='orange')
# plt.plot([y_test.min(), y_test.max()], [y_test.min(), y_test.max()], 'r--', label='Ideal')
# plt.xlabel('Actual Lap Time (sec)')
# plt.ylabel('Predicted Lap Time (sec)')
# plt.title('Optuna Decision Tree: Actual vs Predicted Lap Times')
# plt.legend()
# plt.grid(True)
# plt.tight_layout()
# plt.show()
